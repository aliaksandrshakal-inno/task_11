...
CREATE DOMAIN public."bigint_domain" AS bigint;


ALTER DOMAIN public."bigint_domain" OWNER TO postgres;
...
CREATE OR REPLACE FUNCTION public.customer (
...
CREATE OR REPLACE FUNCTION public.category (
...
CREATE OR REPLACE FUNCTION public.film (
...
CREATE OR REPLACE FUNCTION public.film_actor (
...
CREATE OR REPLACE FUNCTION public.film_category (
    film_id integer NOT NULL,
...
CREATE OR REPLACE FUNCTION public.address (
...
CREATE OR REPLACE FUNCTION public.city (
...
CREATE OR REPLACE FUNCTION public.country (
...
CREATE OR REPLACE FUNCTION public.inventory (
...
CREATE OR REPLACE FUNCTION public.language (
...
CREATE OR REPLACE FUNCTION public.payment (
...
CREATE OR REPLACE FUNCTION public.payment_p2022_01 (
    payment_id integer DEFAULT nextval('public.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE OR REPLACE FUNCTION public.payment_p2022_02 (
    payment_id integer DEFAULT nextval('public.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE OR REPLACE FUNCTION public.payment_p2022_03 (
    payment_id integer DEFAULT nextval('public.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE OR REPLACE FUNCTION public.payment_p2022_04 (
    payment_id integer DEFAULT nextval('public.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE OR REPLACE FUNCTION public.payment_p2022_05 (
    payment_id integer DEFAULT nextval('public.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE OR REPLACE FUNCTION public.payment_p2022_06 (
    payment_id integer DEFAULT nextval('public.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE OR REPLACE FUNCTION public.payment_p2022_07 (
    payment_id integer DEFAULT nextval('public.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE OR REPLACE FUNCTION public.rental (
...
CREATE OR REPLACE FUNCTION public.staff (
...
CREATE OR REPLACE FUNCTION public.store (
