-- Pushing all Pagila objects to a dedicated schema
DROP SCHEMA IF EXISTS pagila CASCADE; 
CREATE SCHEMA pagila;
SET search_path TO pagila, public;

-- Drop domain/types if exist since Postgres doesn't support IF NOT EXISTS for them
DROP DOMAIN IF EXISTS pagila.bigint_domain CASCADE;
DROP DOMAIN IF EXISTS pagila.year CASCADE;
DROP TYPE IF EXISTS pagila.mpaa_rating CASCADE;
--
...
-- Создаем отдельную схему для данных, чтобы не трогать системные таблицы Airflow
CREATE SCHEMA IF NOT EXISTS pagila_data;
SET search_path TO pagila_data, public;
...
--
-- Name: bigint_domain; Type: DOMAIN; Schema: public; Owner: postgres
--

CREATE DOMAIN pagila."bigint_domain" AS bigint;


ALTER DOMAIN pagila."bigint_domain" OWNER TO postgres;
...
CREATE OR REPLACE FUNCTION pagila._group_concat(text, text) RETURNS text
...
CREATE OR REPLACE FUNCTION pagila.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) RETURNS SETOF integer
    LANGUAGE sql
    AS $_$
     SELECT inventory_id
     FROM inventory
...
CREATE OR REPLACE FUNCTION pagila.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) RETURNS SETOF integer
    LANGUAGE sql
    AS $_$
    SELECT inventory_id
    FROM inventory
...
CREATE OR REPLACE FUNCTION pagila.get_customer_balance(p_customer_id integer, p_effective_date timestamp with time zone) RETURNS numeric
    LANGUAGE plpgsql
    AS $$
...
CREATE OR REPLACE FUNCTION pagila.inventory_held_by_customer(p_inventory_id integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION pagila.inventory_in_stock(p_inventory_id integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_rentals INTEGER;
...
CREATE OR REPLACE FUNCTION pagila.last_day(timestamp with time zone) RETURNS date
...
CREATE OR REPLACE FUNCTION pagila.last_updated() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE SEQUENCE IF NOT EXISTS pagila.customer_customer_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.customer (
...
CREATE OR REPLACE FUNCTION pagila.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) RETURNS SETOF pagila.customer
...
-- 1. Сначала удаляем старый агрегат, если он есть
DROP AGGREGATE IF EXISTS pagila.group_concat(text) CASCADE;

-- 2. Теперь создаем его заново
...
CREATE SEQUENCE IF NOT EXISTS pagila.actor_actor_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.actor (
...
CREATE SEQUENCE IF NOT EXISTS pagila.category_category_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.category (
...
CREATE SEQUENCE IF NOT EXISTS pagila.film_film_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.film (
...
CREATE TABLE IF NOT EXISTS pagila.film_actor (
...
CREATE TABLE IF NOT EXISTS pagila.film_category (
    film_id integer NOT NULL,
...
CREATE OR REPLACE VIEW pagila.actor_info AS
 SELECT a.actor_id,
    a.first_name,
    a.last_name,
...
CREATE SEQUENCE IF NOT EXISTS pagila.address_address_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.address (
...
CREATE SEQUENCE IF NOT EXISTS pagila.city_city_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.city (
...
CREATE SEQUENCE IF NOT EXISTS pagila.country_country_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.country (
...
CREATE OR REPLACE VIEW pagila.customer_list AS
...
CREATE OR REPLACE VIEW pagila.film_list AS
...
CREATE SEQUENCE IF NOT EXISTS pagila.inventory_inventory_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.inventory (
...
CREATE SEQUENCE IF NOT EXISTS pagila.language_language_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.language (
...
CREATE OR REPLACE VIEW pagila.nicer_but_slower_film_list AS
 SELECT film.film_id AS fid,
    film.title,
    film.description,
    category.name AS category,
...
CREATE SEQUENCE IF NOT EXISTS pagila.payment_payment_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.payment (
...
CREATE TABLE IF NOT EXISTS pagila.payment_p2022_01 (
    payment_id integer DEFAULT nextval('pagila.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS pagila.payment_p2022_02 (
    payment_id integer DEFAULT nextval('pagila.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS pagila.payment_p2022_03 (
    payment_id integer DEFAULT nextval('pagila.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS pagila.payment_p2022_04 (
    payment_id integer DEFAULT nextval('pagila.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS pagila.payment_p2022_05 (
    payment_id integer DEFAULT nextval('pagila.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS pagila.payment_p2022_06 (
    payment_id integer DEFAULT nextval('pagila.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS pagila.payment_p2022_07 (
    payment_id integer DEFAULT nextval('pagila.payment_payment_id_seq'::regclass) NOT NULL,
    customer_id integer NOT NULL,
    staff_id integer NOT NULL,
    rental_id integer NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS pagila.rental_rental_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.rental (
...
CREATE OR REPLACE VIEW pagila.sales_by_film_category AS
 SELECT c.name AS category,
    sum(p.amount) AS total_sales
   FROM (((((pagila.payment p
     JOIN pagila.rental r ON ((p.rental_id = r.rental_id)))
...
CREATE SEQUENCE IF NOT EXISTS pagila.staff_staff_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.staff (
...
CREATE SEQUENCE IF NOT EXISTS pagila.store_store_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS pagila.store (
...
CREATE OR REPLACE VIEW pagila.sales_by_store AS
...
CREATE OR REPLACE VIEW pagila.staff_list AS
